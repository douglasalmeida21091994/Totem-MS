            ...
            <div class="history-content">
                ...
                <div class="history-summary">
                    ...
                    <div class="summary-item">
                        ...
                        <span class="summary-value" id="atendimentosHoje">0</span>
                    </div>
                </div>
            </div>
        </div>
...
function atualizarTempos() {
    ...
    document.querySelectorAll('.tempo-espera[data-timestamp]').forEach(function(el) {
        ...
        var seg = dif % 60;
        if (!el.closest('.atendido'))
            el.innerHTML = '<i class="fas fa-clock"></i> Aguardando há ' + min + ' min e ' + seg + ' seg';
    });
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function atualizarResumo(historico) {
        ...
        const atendimentosHoje = historico.filter(item => item.data === hoje).length;
